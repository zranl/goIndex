...
// 在head 中 加载 必要静态
document.write(
  '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/zranl/goIndex/css/mdui.min.css">'
);
document.write(
  '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/zranl/goIndex/css/nexmoe.min.css">'
);
// markdown支持
document.write(
  '<script src="//cdn.jsdelivr.net/gh/zranl/goIndex/js/markdown-it.min.js"></script>'
);
document.write(
...
document.write(
  '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/zranl/goIndex/css/DPlayer.min.css">'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/zranl/goIndex/js/DPlayer.min.js"></script>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/zranl/goIndex/js/hls.min.js"></script>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/zranl/goIndex/js/flv.min.js"></script>'
);
    ...
    <div class="navSize">
			...
			<div class="nav_menu">
				<ul class="menu_ul">
					...
					<li class="menu_li"><a href="https://ptu.lyuan.workers.dev" target="_blank">PTU</a></li>
				</ul>
...
<script src="//cdn.jsdelivr.net/gh/zranl/goIndex/js/ace.js"></script>
<script src="//cdn.jsdelivr.net/gh/zranl/goIndex/js/ext-language_tools.js"></script>
	`;
  $("#content").html(content);
